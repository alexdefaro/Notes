    ...
    return (
        <div tabIndex="0" aria-label={`card ${user.id}`} className="focus:outline-none w-4/5 mb-7 bg-white dark:bg-gray-800 p-6 shadow rounded">
            ...
            <div className="px-2">
                ...
                <button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-1 px-2 border border-gray-400 rounded shadow" onClick={() => loadRepositories(user.userName)}>
                    Load repositories
                    {
                        loading &&
                        <svg role="status" className="inline ml-2 w-4 h-4 text-black animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
